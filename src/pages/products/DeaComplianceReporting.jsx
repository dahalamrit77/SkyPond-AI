// product page -> DeaComplianceReporting (refactored)
...
function DiagramNode({ icon, title, sub, pills, highlight }) {
  return (
    <div style={{
...
export default function DeaComplianceReporting() {
  return (
    <>
      <Navbar />
      <Breadcrumb items={[
        ...
        { label: "DEA Compliance Reporting", href: null },
      ]} />
      <main>
        <Hero />
        <Features />
