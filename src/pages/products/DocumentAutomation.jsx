// product page -> Document Automation Page (refactored to match service-page patterns)
        ...
        <div style={{ display: 'grid', gridTemplateColumns: 'minmax(0, 1.32fr) minmax(0, 0.82fr)', gap: 56, alignItems: 'center' }}>
          <div style={{ minWidth: 0, animation: 'fadeUp 0.6s ease both' }}>
            <div style={{ marginBottom: 22 }}>
              <Badge c={C.p}><Zap size={12} /> Document Automation</Badge>
            </div>
            ...
            <P style={{ marginBottom: 36, fontSize: '1rem', fontWeight: 300, maxWidth: '100%' }}>
              LTC pharmacy operations run on paperwork. Prior auth letters, facility service agreements, patient consent forms, compliance notices — Document Automation replaces manual assembly with template-driven generation, e-signature routing, and HIPAA-compliant archiving.
            </P>
...
export default function DocumentAutomation() {
  return (
    <>
      <Navbar />
      <Breadcrumb items={[{ label: 'Home', href: '/' }, { label: 'Products', href: '/products' }, { label: 'Document Automation', href: null }]} />
      <main>
        <Hero />
        <Features />
        <HowItWorks />
