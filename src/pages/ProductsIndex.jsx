...
function Hero() {
  return (
    <section style={{
      padding: '96px max(24px, 5vw) 88px',
      background: C.dark,
      position: 'relative',
      overflow: 'hidden',
      textAlign: 'center',
      ...
      <div style={{
        ...
        <h1 style={{
          fontFamily: "'Akshar', sans-serif",
          fontSize: 'clamp(2.35rem, 4.8vw, 3.35rem)',
          fontWeight: 900,
          color: '#ffffff',
          lineHeight: 1.12,
        ...
        <p style={{
          fontSize: 'clamp(1rem, 1.08vw, 1.06rem)',
        ...
        return (
          <button
            ...
            style={{
              ...
              padding: '15px 20px',
              color: active ? C.green : 'rgba(255,255,255,0.58)',
              fontFamily: "'Gotham', 'Helvetica Neue', Arial, sans-serif",
              fontSize: 13,
              fontWeight: 500,
              cursor: 'pointer',
...
function FeatureLi({ children, last }) {
  return (
    <li style={{
      display: 'flex',
    ...
    >
      ...
      <div style={{ padding: '24px 28px', flex: 1, display: 'flex', flexDirection: 'column' }}>
        ...
        <ul style={{ listStyle: 'none', marginBottom: 24, flex: 1 }}>
          {product.features.map((f, idx, arr) => (
...
function GridSection({ visibleProducts }) {
  return (
...
export default function ProductsIndex() {
  ...
  return (
    <>
      ...
      <Navbar />
      <Breadcrumb items={[{ label: 'Home', href: '/' }, { label: 'Products', href: null }]} />
      <main>
        <Hero />
