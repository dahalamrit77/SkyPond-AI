...
/**
 * Site footer — migrated from src/components/Footer.jsx.
 * Needs 'use client' for hover state. Zero design changes.
 * Replaced: import.meta.env.BASE_URL → hardcoded /navbar-logo-white.png
      ...
      <div style={{ maxWidth: 1100, margin: '0 auto' }}>
        ...
        >
          ...
          <div>
            ...
            >
              The complete LTC pharmacy technology platform. DEA compliance, AI automation,
              analytics, PointClickCare, and more.
            </p>
            <span
              style={{
                display:    'block',
            ...
            {([
              ['✉ ' + CONTACT_EMAIL,         `mailto:${CONTACT_EMAIL}`,  'email'],
              ['☎ ' + CONTACT_PHONE_DISPLAY,  `tel:${CONTACT_PHONE}`,    'phone'],
            ] as [string, string, string][]).map(([text, href, id]) => (
              <a
                key={id}
                href={href}
                style={{
                  display:         'block',
                  color:           hoveredLink === id ? C.p2 : 'rgba(255,255,255,0.65)',
                  fontSize:        12.5,
                  textDecoration:  'none',
                  marginBottom:    4,
                  fontFamily:      "'Gotham', 'Helvetica Neue', Arial, sans-serif",
        ...
        >
          ...
          >
            © {new Date().getFullYear()} Skypond Tech Pvt. Ltd. · All Rights Reserved
          </span>
