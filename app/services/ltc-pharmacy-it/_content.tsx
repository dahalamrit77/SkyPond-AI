...
function Related() {
  const items = [
    ...
    { icon:<BarChart3 size={20} />, color:'#F79043', tag:"Service", title:"Data Analytics & Power BI", href:"/services/data-analytics",
...
/* ─── Page export ─────────────────────────────────────────────────────────── */
export function LtcPharmacyItContent() {
  return (
    <>
      <Breadcrumb items={[{ label: 'Home', href: '/' }, { label: 'Services', href: '/services' }, { label: 'LTC Pharmacy IT' }]} />
      <main>
        <Hero />
        <Problem />
        <Capabilities />
