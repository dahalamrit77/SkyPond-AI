...
const SERVICES = [
  ...
  {
    icon: <Settings size={28} />, color: C.amber,
  ...
  {
    icon: <BarChart3 size={28} />, color: C.green,
  ...
  {
    icon: <Laptop size={28} />, color: C.red,
  ...
  {
    icon: <LinkIcon size={28} />, color: C.green,
