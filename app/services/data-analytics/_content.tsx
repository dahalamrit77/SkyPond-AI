...
function DashboardWidget() {
  ...
  const pts = dispensing.map((d: any,i: any) => `${(i/(dispensing.length-1))*W},${H_chart - (d.v/maxV)*H_chart}`).join(" ");
        ...
        <div style={{ display:"grid", gridTemplateColumns:"1fr 1fr 1fr 1fr", gap:10, marginBottom:20 }}>
          {kpis.map((k: any,i: any) => (
            <div key={i} style={{ padding:"12px 12px", borderRadius:10,
              ...
              <div style={{ fontSize:18, fontWeight:900, color:k.c, fontFamily:"'Akshar', sans-serif",
      ...
      <div style={{ maxWidth:1100, margin:"0 auto" }}>
        <div style={{ display:"grid", gridTemplateColumns:"1fr 1fr", gap:72, alignItems:"start" }}>
          <div>
            ...
            <div style={{ padding:"16px 18px", borderRadius:12, background:`${C.border}08`,
              border:`1px solid ${C.border}22` }}>
              <div style={{ fontSize:13.5, color:C.p, fontWeight:600, lineHeight:1.6 }}>
...
function HowItWorks() {
  const steps = [
    { n:"01", title:"Data Audit & Source Mapping", desc:"We start by documenting every data source in your pharmacy — PMS exports, EHR feeds, spreadsheets, manual logs — and assessing the quality, structure, and refresh frequency of each.", color:C.p },
    ...
    { n:"03", title:"Data Pipeline Architecture", desc:"We design and build the ETL pipeline that pulls data from your sources, cleans and structures it, and loads it into Power BI or your data warehouse on your required refresh schedule.", color:C.p },
    { n:"04", title:"Dashboard Build & Iteration", desc:"We build the dashboards with your team's input at every stage. You see working prototypes early — not finished products that miss the mark. We iterate until every view is genuinely useful.", color:C.p },
    { n:"05", title:"Training & Handoff", desc:"We train the team that will use and maintain the dashboards — not just the admin. Full documentation, a Power BI walkthrough, and a clear runbook for adding new data sources or metrics.", color:C.p },
    { n:"06", title:"Ongoing Optimization", desc:"Dashboards should evolve as your pharmacy grows. We stay engaged — adding new views, incorporating new data sources, and refining metrics as your operation changes.", color:C.p },
  ];
  return (
    <section style={{ padding:"88px 5vw", background:C.surface }}>
      <div style={{ maxWidth:1100, margin:"0 auto" }}>
...
function Related() {
  const items = [
    ...
    { icon:<TrendingUp size={20} />, color:C.p, tag:"Product", title:"LTC Analytics Dashboard", href:"/products/ltc-analytics",
    ...
    <section style={{ padding:"80px 5vw", background:C.surface, borderTop:`1px solid ${C.border}`,
      ...
      <div style={{ maxWidth:660, margin:"0 auto", textAlign:"center", position:"relative", zIndex:1 }}>
        ...
        <div style={{ display:"flex", gap:12, justifyContent:"center", flexWrap:"wrap" }}>
          <Button variant="primary" size="md" to="/schedule-demo">Book a Data Discovery Session →</Button>
...
export function DataAnalyticsContent() {
  return (
    <>
      <Breadcrumb items={[{ label: 'Home', href: '/' }, { label: 'Services', href: '/services' }, { label: 'Data Analytics' }]} />
      <main>
        <Hero />
        <Problem />
        <Dashboards />
