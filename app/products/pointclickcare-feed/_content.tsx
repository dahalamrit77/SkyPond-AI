...
function FlowNode({ icon, title, sub, pills, highlight }: { [key: string]: any }) {
  return (
    <div style={{
...
function FlowConnector({ tag }: { [key: string]: any }) {
  return (
...
/* ─── Page export ─────────────────────────────────────────────────────────── */
export function PointClickCareFeedContent() {
  return (
    <>
      <Breadcrumb items={[{ label: 'Home', href: '/' }, { label: 'Products', href: '/products' }, { label: 'PointClickCare Feed' }]} />
      <main>
        <Hero />
        <Features />
        <HowItWorks />
